            ...
            <div class='form-group'>
                <div class="col-sm-12">
                    <div class="modal-footer">
                        ...
                        <!--<a class="btn btn-primary" href="http://abc.5xieys.cn/web/index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=order.batchsend.import" style="margin-right: 10px;" ><i class="fa fa-download" title=""></i> 下载Excel模板文件</a>-->
                    </div>
                </div>
            </div>
    </div>
