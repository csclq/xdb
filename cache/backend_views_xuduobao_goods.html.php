        ...
        <div class="page-heading">
            ...
            <div class="page-toolbar row m-b-sm m-t-sm">
                <div class="col-sm-2 pull-left">
                    <select name="delete" class='form-control input-sm select-sm select2'>
                        <option value="0" selected>商品上架</option>
                        <option value="1">商品售罄</option>
                        <option value="2">商品回收</option>
                        <option value="3">商品仓库</option>
                    </select>
                </div>
                <div class="col-sm-8 pull-right">
                    ...
                    <div class="input-group">
                        <input type="text" class="input-sm form-control" name='keyword' value="" placeholder="ID/名称/编号/条码/商户名称" ng-model="info.filter">
                        <span class="input-group-btn">
                            <button class="btn btn-sm btn-primary" type="submit" ng-click="search()"> 搜索</button>  &nbsp; &nbsp;
                        <button style="border:none;margin-left: 5px;"><a href="goodsedit" class="btn btn-sm btn-primary" >添加</a></button></span>
                    </div>
