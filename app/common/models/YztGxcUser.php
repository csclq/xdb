...
class YztGxcUser extends \Phalcon\Mvc\Model
{
    ...
    /**
     * Method to set the value of field qq_openid
     *
     * @param string $qq_openid
     * @return $this
     */
    public function setQqOpenid($qq_openid)
    {
    ...
    /**
     * Method to set the value of field partner
     *
    ...
    /**
     * Method to set the value of field partner_type
     *
     * @param integer $partner_type
     * @return $this
     */
    ...
    /**
     * Returns the value of field qq_openid
     *
     * @return string
     */
    ...
    /**
     * Returns the value of field partner
     *
     * @return integer
     */
    ...
    /**
     * Returns the value of field partner_type
     *
     * @return integer
     */
    ...
    {
        $this->setSchema("gxc");
        $this->hasMany('id', 'App\Models\YztGxcApplyPartner', 'user_id', ['alias' => 'YztGxcApplyPartner']);
        $this->hasMany('id', 'App\Models\YztGxcLoveStory', 'user_id', ['alias' => 'YztGxcLoveStory']);
        $this->hasMany('id', 'App\Models\YztGxcLoveStoryPraise', 'user_id', ['alias' => 'YztGxcLoveStoryPraise']);
        $this->hasMany('id', 'App\Models\YztGxcPartner', 'user_id', ['alias' => 'YztGxcPartner']);
        $this->hasMany('id', 'App\Models\YztGxcPublish', 'user_id', ['alias' => 'YztGxcPublish']);
        $this->hasMany('id', 'App\Models\YztGxcUserinfo', 'user_id', ['alias' => 'YztGxcUserinfo']);
        ...
        $this->hasMany('id', 'App\Models\YztUserDispatch', 'user_id', ['alias' => 'YztUserDispatch']);
    }
